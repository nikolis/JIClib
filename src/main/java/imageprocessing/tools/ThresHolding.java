...
public class ThresHolding {
	...
	public static Hashtable<Integer, Double> findThresHoldVariances(BufferedImage grayImage) {
		Hashtable<Integer, Double> thresHolds = new Hashtable<>();// Integer=Intensity
																	// value
																	// Double=weights
		...
		for (int thresHold = 10; thresHold < 256; thresHold += 10) {
			...
			// System.out.println("within class variance is : "+
			// withinClassVariance);
	...
	/**
	 * This method is used to calculate the 2 weighted class variances that are
	 * given as an array of numbers containing on set along with the threshold
