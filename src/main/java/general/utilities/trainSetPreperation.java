...
public class trainSetPreperation {
	...
	/**
	 * This method is using The main method of labeling in order to extract the
	 * subImages of an The Input image defined by the number taken as parameter
	 * 
	...
	/**
	 * Overloaded method that the only difference with the previous is that it
	 * can accept the Image as a parameter
	 * 
	 * @param numberOfExample
	 */
