...
/**
 * @author Nikolis
 * The only reason for creating separate class for this is that 
 * we need to store also the Thetas in different classes and
 * If we don't know in advance the number of Thetas arrays
 * because we don't know in advance the number of layers in a
 * neuralNetwork
 */
